...
Define user-set per-day targets for macros and micros, with `GET`/`PUT` endpoints and adherence computation that the summary capability composes into its responses.
